        ...
        <>
            ...
            <footer className='main-container grid md:grid-cols-2 lg:grid-cols-4 gap-10 py-20'>
                ...
                <div>
                    ...
                    <ul className='flex flex-col gap-2 text-base lf:text-lg'>
                        <li>
                            <a href="">Web Design</a>
                        </li>
                ...
                <div>
                    ...
                    <ul className='flex flex-col gap-2 text-base lf:text-lg'>
                        <li>
                            <a href="">witalonlopez@gmail.com</a>
                        </li>

                        <li>
                            <a href="">+55 34 98413-3145</a>
                        </li>
                    </ul>
                </div>
            </footer>
            ...
            <div className="main-container grid md:grid-cols-2 gap-3 py-6 lg:py-8 max-md:text-center">
                <div className='text-base lg:text-lg'>© 2025 WL | Todos os direitos reservados</div>
