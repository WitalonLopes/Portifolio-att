    ...
    <>
      <div ref={heroRef} className='relative overflow-hidden'>
        <div className='main-container h-screen flex flex-col lg:justify-center items-start lg:py-12 max-lg:pt-40'>
          <h1 className='text-3xl lg:text-[3.2vw] uppercase font-heading font-semibold'>Witalon Lopes</h1>
          <h2 className='text-6xl lg:text[8vw] font-heading font-bold leading-[1] tracking-tight mt-3 mb-6'>Web Developer <br />& <span className='text-stroke'> UI/UX </span> </h2>
          <GradientButton text="Fale Comigo" link="mailto:witalonlopez@gmail.com" className='gradient-btn'/>
        </div>
